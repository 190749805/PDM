...
<div class="center">
    ...
    <table style="width:700px;margin-left:100px;" class="table table-striped">
        ...
        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr class="cl<?php echo ($info["qk"]); ?>">
                <td>
                    <?php echo ($info["id"]); ?>
                </td>
                <td>
                ...
                <td>
                    <a href="__URL__/auditing/id/<?php echo ($info["id"]); ?>"><?php echo ($info["username"]); ?></a>
                </td>
                <td>
                    <?php echo ($info["name"]); ?>
                </td>
