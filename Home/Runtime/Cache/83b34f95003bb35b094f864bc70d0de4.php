		...
		<div class="row">
			...
			<div class="col-md-10">
				<table style="width:700px"; class="table table-striped">
					...
					<tr>
						<?php if(is_array($deal_user)): $i = 0; $__LIST__ = $deal_user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$deal_user): $mod = ($i % 2 );++$i;?><td>							
							<?php echo ($deal_user["username"]); ?>							
						</td>
						<td>
							<a href="__URL__/init_user/id/<?php echo ($deal_user["id"]); ?>">重置</a>
