...
<div class="center">
	...
	<p class="info" style="margin-left:100px;">基本信息</p><br/><br/>

	<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><p class="info" style="margin-left:200px;margin-top:100px;">姓名:	<?php echo ($info["name"]); ?></p>
		<p class="info" style="margin-left:500px;margin-top:-40px;">照片:	</p>
		<img class="img-photo" style="margin-left:600px;margin-top:-180px;" src="<?php echo ($info["zplj"]); ?>" />
		
		<p class="info" style="margin-left:200px;margin-top:60px;">部门:	<?php echo ($info["bm"]); ?></p>
		<p class="info" style="margin-left:500px;margin-top:-40px;">权限:	<?php echo ($info["qx"]); ?></p>
		
		<p class="info" style="margin-left:200px;margin-top:90px;">状态:	<?php echo ($status); ?></p>
		<p class="info" style="margin-left:500px;margin-top:-40px;"><?php echo ($change_to_audit); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>
	<br/><br/><br/><br/><br/>
</div>
