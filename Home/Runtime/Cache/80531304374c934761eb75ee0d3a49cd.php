...
<script type="text/javascript" src="__PUBLIC__/Js/jquery.cityselect.js"></script>
	...
	<div class="center">
		...
		<div class="row">
			...
			<div class="col-md-10">
				<button class="btn btn-primary " data-toggle="modal" data-target="#myModal">点击申请</button>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a href="__URL__/up_init"><button type="button" class="btn btn-primary">确定</button></a>
				</div>
			</div>
		</div>
    </div>
